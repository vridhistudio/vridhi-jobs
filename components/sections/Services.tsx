...
const services = [
  ...
  },
  {
    ...
    desc: "Beyond services — we build tools and take on high-impact projects that others won't touch.",
...
export default function Services() {
  return (
    <section id="services" className="section-pad px-6 bg-[#0c0c0c]">
        ...
        <div className="divide-y divide-[rgba(255,255,255,0.06)]">
          {services.map((s, i) => (
            <Reveal key={s.n} delay={i * 0.05}>
              <div className="grid md:grid-cols-[72px_1fr_280px] gap-8 md:gap-12 py-12 group">
                ...
                <div>
                  ...
                  <p className="text-[#777] text-sm leading-relaxed mb-5 max-w-md">{s.desc}</p>
                  <a href={s.href} className="text-sm font-semibold inline-flex items-center gap-1.5 transition-all duration-200 hover:gap-3" style={{ color: s.color }}>
                    {s.cta}
                  </a>
                </div>
